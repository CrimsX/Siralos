...
differential parity); R7.2 — Application Tool Loop parity — complete and evidence-backed; R7.3 — Projection parity — complete and evidence-backed; R7.4 — Configuration parity — completed Rust candidate pending independent completion review (2 required `user-config` scenarios, corpus version 15, 133 scenario files); R7.5 is not started). The complete
