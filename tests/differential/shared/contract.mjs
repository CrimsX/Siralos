...
export const CORPUS_VERSION = 69;
...
function validateSubjectInputs(scenario, label) {
  ...
  if (scenario.subject === "provider-replay") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(`${label} provider-replay inputs must use platforms ["*"] and an empty env`);
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
    }
  ...
  if (scenario.subject === "session-replay") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(`${label} session-replay inputs must use platforms ["*"] and an empty env`);
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
    }
  ...
  if (scenario.subject === "replay-store") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(`${label} replay-store inputs must use platforms ["*"] and an empty env`);
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
    }
  ...
  if (scenario.subject === "context-graph") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(`${label} context-graph inputs must use platforms ["*"] and an empty env`);
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
    }
  ...
  if (scenario.subject === "context-representation") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(
        `${label} context-representation inputs must use platforms ["*"] and an empty env`,
      );
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
  ...
  if (scenario.subject === "context-scheduler") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(
        `${label} context-scheduler inputs must use platforms ["*"] and an empty env`,
      );
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
  ...
  if (scenario.subject === "context-tool") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(`${label} context-tool inputs must use platforms ["*"] and an empty env`);
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
    }
  ...
  if (scenario.subject === "context-benchmark") {
    if (platforms.size !== 1 || !platforms.has("*") || envKeys.size !== 0) {
      throw new Error(
        `${label} context-benchmark inputs must use platforms ["*"] and an empty env`,
      );
    }
    if (!Object.hasOwn(scenario, "input") || !isPlainRecord(scenario.input)) {
      throw new Error(`${label}.input must be a plain object`);
