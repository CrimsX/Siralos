...
| R13.5d Full cli-session closure      | `cli-session` closure                                          | [decision 31](../decisions/31-r13-5d-entry-review.md) PASS (7 groups at v31)                              | landed (corpus v31, parity held 231/231 locally — `cli-session` closure ×7: godot ×9, gdscript ×7, develop ×5, system ×8, queue ownership, sanitizer, ordering)                     |
