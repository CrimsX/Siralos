...
- Current position: R1–R6 Verified, R7 Active (R7A/R7.1/R7.2/R7.3/R7.4 complete & evidence-backed; R7.5 completed Rust candidate pending independent review; corpus v15, 133 scenario files, 128/128 applicable Windows). R8+ Not due. See `docs/development/PROJECT_CONTEXT.md`, `docs/development/RUST_MIGRATION.md`, `ROADMAP.md`.
