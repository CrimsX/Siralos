...
- Current position: R1–R7 Verified, R8 **Verified** at `c075b3cf5e52` / `baeb447` (six Godot Stage-2 surfaces ported and evidence-backed; corpus v16 155 files, 150/150 applicable required scenarios across all five frozen `godot-*` subjects; fail-closed posture mechanically preserved). R9 **Verified** at `1623e800f8034` / `9b83cd8` (three Godot Stage-3 deterministic surfaces ported and evidence-backed; corpus v17 167 files, 162/162 applicable required scenarios across the three frozen subjects; apply/checkpoints typed `unavailable`). R10+ not due pending the R10 entry review. See `docs/development/PROJECT_CONTEXT.md`, `docs/development/RUST_MIGRATION.md`, `ROADMAP.md`, `docs/wayfinder/decisions/13-r9-verified-promotion.md`.
