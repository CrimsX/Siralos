...
- **Q1 Slice scope** — approved: *"Core + adapters, session deferred
  (Recommended)"* — "Consistent with 5.3: consumption surfaces wait; the
  selection semantics freeze and hold differential evidence first."
- **Q2 Subject matrix** — approved: *"composition-plugin-selection x4 as
  drafted (Recommended)"* — "Covers the filter property end to end including
  the truthful diagnostics case."
- **Q3 Semantics** — approved: *"Confirm (Recommended)"* — "The profile
