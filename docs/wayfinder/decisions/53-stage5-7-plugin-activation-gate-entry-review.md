...
- **Q1 Slice scope** — approved: *"Core gate + CLI wiring + v45 subject
  (Recommended)"* — "The slice's point is consumption - the frozen 5.5
  filter gates the real activate command."
- **Q2 Subject matrix** — approved: *"composition-plugin-activation x4 as
  drafted (Recommended)"* — "Covers gate transparency, the narrowed allow,
  the filtered refusal, and Host-authority precedence over any profile."
- **Q3 Semantics** — approved: *"Confirm (Recommended)"* — "Host authority
