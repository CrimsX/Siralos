...
**Stage 4 is Verified** at `9566eee` (fresh full-gate run: differential 259/259 applicable required at corpus v38/264 files with 25 expectation records and the pinned v32 oracle untouched; fmt/clippy/tests/doc-links green; spawn sweeps over `siralos-core::runtime` and `siralos-godot` clean; core domain neutrality green). The marker is carried in the map and AGENTS.md Current at the record-complete commit.
