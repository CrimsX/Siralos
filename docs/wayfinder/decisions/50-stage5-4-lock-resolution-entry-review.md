...
- **Q1 Slice scope** — approved: _"Core model + adapters + atomic write
  (Recommended)"_ — "Completes the ADR 0036 sec 8-9 pair: deterministic
  regeneration, verify-vs-regenerate flow, one proven write pattern."
- **Q2 Subject matrix** — approved: _"composition-lock x4 as drafted
  (Recommended)"_ — "Covers identity resolution, sorted plugin inclusion, and
  truthful verification outcomes."
- **Q3 Posture** — approved: _"Confirm (Recommended)"_ — "The lock is derived
