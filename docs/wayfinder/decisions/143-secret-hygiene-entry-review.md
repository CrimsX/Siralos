...
| F4 FORMAT FOLLOW-UP                  | `2a23e6f` repairs the 139/140 records' formatting, which had been committed before `format:check` ran over them.                                                                                                    | the `2a23e6f` diff (wayfinder records only)                                                                           |
...
`34638d3` (plus the `2a23e6f` formatting repair) is the correct fix —
