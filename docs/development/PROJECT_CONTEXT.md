...
The internal Stage 4 sequence is realized — every step implemented, entry-reviewed, and evidence-backed, with Stage 4 Verified at `9566eee`:
...
Stage 4.1 is generic runtime execution, never shorthand for "run Godot." It
landed first (with runtime evidence at the v32 reconciliation); the six later
steps followed under decisions 41–45 and the whole stage is Verified.
