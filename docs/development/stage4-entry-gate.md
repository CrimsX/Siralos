...
| --- | --------------------------------------------------------------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Stage 1–3 Rust migration audit passes                                       | **NOT MET**                | R1-R3 are verified (foundation, R2 harness, and the R3 task kernel); R4+ subsystem ports pending. The differential audit (ADR 0033) is the audit mechanism and runs green on the current surface.   |
...
| 3   | H1 (content identity/digests) verified in Rust                              | **NOT MET**                | Port pending (R4+).                                                                                                                                                                                 |
...
Stage 1–3 migration audit and the H1/H2/ICM/H3 ports complete (R4+).
