...
| Differential behavioral harness (Stage 3R R2)                            | `tests/differential/**`, `crates/siralos-cli/src/harness.rs`, `crates/siralos-cli/src/bin/siralos-harness.rs`                                 | ADR-0033                                                                                                           | ADR-0033                                                   |
| Rust task kernel (Stage 3R R3)                                           | `crates/siralos-core/src/task/**`, `crates/siralos-core/src/identity/**`                                                                      | `docs/development/RUST_MIGRATION.md`, `docs/development/RUST_STYLE.md`                                             | ADR-0032, ADR-0033                                         |
| Domain host ABI (Godot domain boundary)                                  | `experiments/domain-abi/**`                                                                                                                   | ADR-0034                                                                                                           | ADR-0034                                                   |
| Domain capability architecture (Stage 3R R6)                             | `crates/siralos-core/src/domain/**`, `crates/siralos-adapters/src/domain/**`, `crates/siralos-adapters/wit/**`, `tests/domain-conformance/**` | ADR-0034, `docs/development/RUST_MIGRATION.md`, `docs/development/PROTOCOL_VERSIONING.md`                          | ADR-0034, ADR-0036                                         |
