...
| Controlled runtime boundary                                              | `packages/core/src/runtime/**`, `experiments/domain-abi/**`                                                                                  | `CONTEXT.md`, `docs/development/RUST_MIGRATION.md`                                                                 | ADR-0031, ADR-0035                                         |
| Migration and external-handoff traceability                              | `crates/**`, `tests/differential/**`, milestone manifests                                                                                    | `docs/development/RUST_MIGRATION.md`, `docs/development/HANDOFF_TRACEABILITY.md`                                   | ADR-0032, ADR-0033                                         |
