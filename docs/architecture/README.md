...
documentation index (the documentation-context executor module; historically `packages/core/src/...` in the removed TypeScript tree).
Keep this page and the runtime index consistent; the architecture check
(`npm run check:rust`) validated frontmatter against the runtime
...
| Deterministic execution / reproducibility                                | `crates/siralos-core/src/determinism/**`                                                                                                      | ADR-0029                                                                                                       | ADR-0029                                                   |
...
| Rust candidate implementation (Stage 3R)                                 | `crates/**`                                                                                                                                   | ARCHITECTURE.md § Rust candidate workspace, `docs/development/RUST_STYLE.md`, `docs/archive/RUST_MIGRATION.md` | ADR-0032                                                   |
| Differential behavioral harness (Stage 3R R2)                            | `tests/differential/**`, `harness/src/harness.rs`, `harness/src/bin/siralos-harness.rs`                                                       | ADR-0033                                                                                                       | ADR-0033                                                   |
| Rust task kernel (Stage 3R R3)                                           | `crates/siralos-core/src/task/**`, `crates/siralos-core/src/identity/**`                                                                      | `docs/archive/RUST_MIGRATION.md`, `docs/development/RUST_STYLE.md`                                             | ADR-0032, ADR-0033                                         |
| Domain host ABI (Godot domain boundary)                                  | `experiments/domain-abi/**`                                                                                                                   | ADR-0034                                                                                                       | ADR-0034                                                   |
| Domain capability architecture (Stage 3R R6)                             | `crates/siralos-core/src/domain/**`, `crates/siralos-adapters/src/domain/**`, `crates/siralos-adapters/wit/**`, `tests/domain-conformance/**` | ADR-0034, `docs/archive/RUST_MIGRATION.md`, `docs/development/PROTOCOL_VERSIONING.md`                          | ADR-0034, ADR-0036                                         |
| Controlled runtime boundary                                              | `packages/core/src/runtime/**`, `experiments/domain-abi/**`                                                                                   | `docs/development/PROJECT_CONTEXT.md`, `docs/archive/RUST_MIGRATION.md`                                        | ADR-0031, ADR-0035                                         |
| Product vision / composition & extension model                           | README.md, ROADMAP.md, ARCHITECTURE.md, `docs/development/PROJECT_CONTEXT.md`, `docs/archive/RUST_MIGRATION.md`                               | ARCHITECTURE.md § Product vision and conceptual ownership                                                      | ADR-0036                                                   |
| Migration and requirements traceability                                  | `crates/**`, `tests/differential/**`, milestone manifests                                                                                     | `docs/archive/RUST_MIGRATION.md`, `docs/requirements/REQUIREMENTS.md`, `docs/architecture/RFC_INDEX.md`        | ADR-0032, ADR-0033                                         |
