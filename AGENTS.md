...
- Next: Stage 3R R4 — Generic Workspace / Project Foundation (behavior extraction → idiomatic Rust redesign → parity → review → measurement, ADR 0032/0033). Do not implement R4+ porting work in the current milestone.
