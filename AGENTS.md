...
- Current: Stage 3R R9 is **Verified** at 1623e800f8034. R1–R8 are Verified as recorded above. R9 — Optional Godot Stage-3 parity (deterministic core) — is complete and evidence-backed (corpus version 17, 167 scenario files; all three frozen subjects at required parity — review-context ×4, mutation-prepare ×4, develop-plan ×4 — 162/162 applicable required scenarios with four explicit platform skips; apply/checkpoints stay typed `unavailable`). R10+ remain not due pending the R10 entry review.
