...
- Current: Stage 3R R8 is **Verified** at c075b3cf5e52. R1–R7 are Verified as recorded above. R8 — Optional Godot Stage-2 parity — is complete and evidence-backed (corpus version 16, 155 scenario files; all five frozen `godot-*` subjects at required parity — discovery ×4, knowledge ×5, diagnostics ×4, lsp ×4, scene-resolve ×5 — 150/150 applicable required scenarios with four explicit platform skips; fail-closed posture mechanically preserved). R9+ remain not due pending the R9 entry review.
