...
export function formatHelp(): string {
  ...
  /godot-probe       Run one approved recovery-mode Godot project probe (disposable mirror)
  /godot-probe-status  Show the last recovery probe result
  /exit              Close Solaris
`;
}
...
Project probe: ${view.projectProbe}
`;
}
